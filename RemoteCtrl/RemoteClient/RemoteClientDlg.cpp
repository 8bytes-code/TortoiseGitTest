...
BEGIN_MESSAGE_MAP(CRemoteClientDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BTN_STRAT_WATCH, &CRemoteClientDlg::OnBnClickedBtnStratWatch)
	ON_WM_TIMER()
END_MESSAGE_MAP()
...
LRESULT CRemoteClientDlg::OnSendPacket(WPARAM wParam, LPARAM lParm) {
	...
	case 5:	//鼠标操作
		{
			ret = SendCommandPacket(cmd, wParam & 1, (BYTE*)lParm, sizeof(MOUSEEV));
		}
		break;
	case 6:
	case 7:
